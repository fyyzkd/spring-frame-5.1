...
public abstract class AbstractBeanDefinitionReader implements BeanDefinitionReader, EnvironmentCapable {
	 ...
	 * @see #loadBeanDefinitions(org.springframework.core.io.Resource[])
	 * 该方法主要做了两件事
	 * (1)调用资源加载器的获取资源方法resourceLoader.getResourceLoader(location),获取要加载的资源
	 * (2)真正实现其加载功能，由其子类XmlBeanDefinitionReader的loadBeanDefinitions(resources)方法实现;
	 */
	...
	// 重载方法，调用loadBeanDefinnitions(String)
	@Override
